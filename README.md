...
1. How would you describe accessibility on the web to someone new to programming?
   -Accessibility is being able to navigate and understand sections and pieces of your webpage with disabilities, such as blindness; Accessibility is also the ability to open your webpage and for it to be fully functional and adaptable to any user's screen size.

2. Talk about 3 different things you can do to ensure your website is accessible.
   -Ensure that measurements are not fixed like pixels (ex of adaptable measurements: rem, %, etc.)

3. How would you explain the concept of a variable to someone new to programming?
   -A variable's purpose is to hold data so that you may be able to implement that specific data into something functional on your webpage.

4. What is the purpose of using functions in code?
   -Functions allow a developer to perform specific tasks for a multitude of uses. (ex. lists, etc.)
